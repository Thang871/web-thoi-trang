...
def home():
    ...
    return render_template('products.html', products=products, cart_items=cart_items, total_price=total_price)
...
def checkout():
    ...
    if cart_items:
        ...
        return render_template('checkout.html', success=True, cart_items=cart_items, total_price=total_price)
